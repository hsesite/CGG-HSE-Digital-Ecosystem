...
const templates=await HDOSRepository.listTemplates("Inspection");
...
<h3 style="margin:0;">${tpl.title}</h3>
...
document.querySelectorAll("#hdos-runtime-checklist .glass-card")
.forEach((card,i)=>{

const answer=
card.querySelector(`input[name="ck-${i}"]:checked`)?.value||"";

const note=
card.querySelector(".runtime-note")?.value||"";

const photoInput=
card.querySelector(".runtime-photo");
